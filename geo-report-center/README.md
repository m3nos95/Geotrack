...
| **Calming** | Traffic calming screen (TCDM 2025) — **defined in-app** as a context filter | Click + **statewide** ranked list. **Show DE schools** on map (FirstMap public + private). Filters: band · min AADT · county · posted 25–35 · **near school** · min crashes · potential roundabout. Stats show school counts + crash overlay. **Screening only.** |
