...
| **Layers** | Which reference layers feed Site Intel + DelDOT FirstMap online overlays | Open → filter / All on / All off / Expand… · **Traffic counts (AADT)** under DelDOT FirstMap · **Traffic calming screen** joins AADT × posted speed × functional class (screening only — not a warrant) |
...
| **Calming** | Traffic calming screen (TCDM 2025) — **defined in-app** as a context filter | Joins nearby AADT + posted speed + functional class. **Candidate** = local/collector ≤35 mph · **Study** = arterial / >35 / incomplete · **Out** = freeway. **Screening aid only — not a warrant.** Always notes missing 85th-percentile speed. |
