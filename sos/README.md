...
7. **Print / PDF** from the letter preview. Yellow Highlight marks print on the PDF. The DelDOT logo is a repeating page footer — body text stops about two lines above it. **Export .doc** (next to Print / PDF) saves a Word file you can edit.
